...
import 'package:my_recipe_book/view_models/recipe_creation_view_model.dart';
...
class _RecipeCreationViewState extends State<RecipeCreationView> {
  ...
  Future<void> _saveRecipe(RecipeCreationViewModel viewModel) async {
    ...
    final success = await viewModel.createRecipe(newRecipe);
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<RecipeCreationViewModel>(
      create: (context) => RecipeCreationViewModel(Provider.of<RecipesRepository>(context, listen: false)),
      child: Consumer<RecipeCreationViewModel>(
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: viewModel.isLoading ? null : () => _saveRecipe(viewModel),
